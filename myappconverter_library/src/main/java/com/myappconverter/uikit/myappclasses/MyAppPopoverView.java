...
public class MyAppPopoverView extends RelativeLayout implements OnTouchListener {
    //********************************************************************
    // STATIC MEMBERS
    //********************************************************************
    /**
     ...
     */
    public final static int PopoverArrowDirectionAny = PopoverArrowDirectionUp |
        PopoverArrowDirectionDown | PopoverArrowDirectionLeft |
        PopoverArrowDirectionRight;

    /**
     * The default popover background drawable for all the popovers
     */
    public static int defaultPopoverBackgroundDrawable = AndroidRessourcesUtils.getResID("background_popover",
            "drawable");

    /**
     * The default popover arrow up drawable for all the popovers
     */
    public static int defaultPopoverArrowUpDrawable = AndroidRessourcesUtils.getResID("icon_popover_arrow_up",
            "drawable");

    /**
     * The default popover arrow down drawable for all the popovers
     */
    public static int defaultPopoverArrowDownDrawable = AndroidRessourcesUtils.getResID("icon_popover_arrow_down",
            "drawable");

    /**
     * The default popover arrow left drawable for all the popovers
     */
    public static int defaultPopoverArrowLeftDrawable = AndroidRessourcesUtils.getResID("icon_popover_arrow_left",
            "drawable");

    /**
     * The default popover arrow down drawable for all the popovers
     */
    public static int defaultPopoverArrowRightDrawable = AndroidRessourcesUtils.getResID("icon_popover_arrow_right",
            "drawable");
    ...
    /**
     * The popover arrow direction
     */
    private int popoverArrowDirection;
     ...
     */
    public MyAppPopoverView(Context context, int layoutId) {
        super(context);
     ...
     * @param layoutId The ID of the layout we want to put inside the popover
     */
    public MyAppPopoverView(Context context, AttributeSet attrs, int layoutId) {
        super(context, attrs);
        initPopoverView(inflate(context, layoutId, null));
    }
     ...
     * @param layoutId The ID of the layout we want to put inside the popover
     */
    public MyAppPopoverView(Context context, AttributeSet attrs, int defStyle,
        int layoutId) {
     ...
     */
    public MyAppPopoverView(Context context, View popoverView) {
        super(context);
     ...
     * @param popoverView The inner view we want to show in a popover
     */
    public MyAppPopoverView(Context context, AttributeSet attrs,
        View popoverView) {
        super(context, attrs);
        initPopoverView(popoverView);
    }
    ...
    private void initPopoverView(View viewToEnclose) {
        ...
        popoverBackgroundDrawable = MyAppPopoverView.defaultPopoverBackgroundDrawable;
        popoverArrowUpDrawable = MyAppPopoverView.defaultPopoverArrowUpDrawable;
        popoverArrowDownDrawable = MyAppPopoverView.defaultPopoverArrowDownDrawable;
        popoverArrowLeftDrawable = MyAppPopoverView.defaultPopoverArrowLeftDrawable;
        popoverArrowRightDrawable = MyAppPopoverView.defaultPopoverArrowRightDrawable;

        //Init the relative layout
        popoverView = new RelativeLayout(getContext());
        popoverView.setBackgroundDrawable(getResources()
                                              .getDrawable(popoverBackgroundDrawable));
        popoverView.addView(viewToEnclose, LayoutParams.FILL_PARENT,
    ...
    private void addPopoverInRect(Rect insertRect) {
        //Set layout params
        LayoutParams insertParams = new LayoutParams(insertRect.width(),
                insertRect.height());
    ...
    private void addArrow(Rect originRect, Integer arrowDirection) {
        ...
        if (arrowDirection == MyAppPopoverView.PopoverArrowDirectionUp) {
            ...
            xPos = originRect.centerX() - (arrowWidth / 2) -
                popoverLayoutRect.left;
            yPos = originRect.bottom - popoverLayoutRect.top;
        } else if (arrowDirection == MyAppPopoverView.PopoverArrowDirectionDown) {
        ...
        } else if (arrowDirection == MyAppPopoverView.PopoverArrowDirectionLeft) {
            ...
            yPos = originRect.centerY() - (arrowHeight / 2) -
                popoverLayoutRect.top;
        } else if (arrowDirection == MyAppPopoverView.PopoverArrowDirectionRight) {
    ...
    private Rect getRectForArrowUp(Rect originRect) {
        ...
        int yAvailable = popoverLayoutRect.height() -
            (originRect.bottom - popoverLayoutRect.top);
        ...
        int originX = (originRect.centerX() - popoverLayoutRect.left) -
            (finalX / 2);
        ...
        //Create rect
        Rect finalRect = new Rect(originX, originY, originX + finalX,
                originY + finalY);
    ...
    private Rect getRectForArrowRight(Rect originRect) {
        ...
        int originY = (originRect.centerY() - popoverLayoutRect.top) -
            (finalY / 2);
    ...
    private Rect getRectForArrowLeft(Rect originRect) {
        //Get available space		
        int xAvailable = popoverLayoutRect.width() -
            (originRect.right - popoverLayoutRect.left);
    ...
    private void addAvailableRects(Rect originRect, int arrowDirections) {
        ...
        if ((arrowDirections & MyAppPopoverView.PopoverArrowDirectionUp) != 0) {
            possibleRects.put(MyAppPopoverView.PopoverArrowDirectionUp,
                getRectForArrowUp(originRect));
        }

        if ((arrowDirections & MyAppPopoverView.PopoverArrowDirectionDown) != 0) {
            possibleRects.put(MyAppPopoverView.PopoverArrowDirectionDown,
                getRectForArrowDown(originRect));
        }

        if ((arrowDirections & MyAppPopoverView.PopoverArrowDirectionRight) != 0) {
            possibleRects.put(MyAppPopoverView.PopoverArrowDirectionRight,
                getRectForArrowRight(originRect));
        }

        if ((arrowDirections & MyAppPopoverView.PopoverArrowDirectionLeft) != 0) {
            possibleRects.put(MyAppPopoverView.PopoverArrowDirectionLeft,
                getRectForArrowLeft(originRect));
        }
    }
     ...
     */
    public void setContentSizeForViewInPopover(
        Point contentSizeForViewInPopover) {
        ...
        realContentSize.x += (popoverView.getPaddingLeft() +
        popoverView.getPaddingRight());
        realContentSize.y += (popoverView.getPaddingTop() +
        popoverView.getPaddingBottom());
    }
    ...
    /**
     * @return Current arrow direction
     */
    ...
    /**
     * @param popoverArrowDirection The new arrow directions
     */
    public void setPopoverArrowDirection(int popoverArrowDirection) {
        this.popoverArrowDirection = popoverArrowDirection;
    }
     ...
     */
    public void showPopoverFromRectInViewGroup(ViewGroup group,
        Rect originRect, int arrowDirections, boolean animated) {
        //Save Arrow direction
        popoverArrowDirection = arrowDirections;
        ...
        android.view.ViewGroup.LayoutParams insertParams = new android.view.ViewGroup.LayoutParams(android.view.ViewGroup.LayoutParams.FILL_PARENT,
                android.view.ViewGroup.LayoutParams.FILL_PARENT);
        group.addView(this, insertParams);

        //Now, save rect for the layout (is the same as the superview)
        popoverLayoutRect = MyAppPopoverView.getFrameForView(superview);
            ...
            if (!isAnimating) {
                ...
                animation.setAnimationListener(new AnimationListener() {
                        ...
                        public void onAnimationEnd(Animation animation) {
                            ...
                            //Tell delegate we did show
                            if (delegate != null) {
                                delegate.popoverViewDidShow(MyAppPopoverView.this);
                            }
                        }
                    });
    ...
    public void dissmissPopover(boolean animated) {
        ...
        if (delegate != null) {
            delegate.popoverViewWillDismiss(MyAppPopoverView.this);
        }
        ...
        if (!animated) {
            ...
            if (delegate != null) {
                delegate.popoverViewDidDismiss(MyAppPopoverView.this);
            }
        } else {
            ...
            if (!isAnimating) {
                ...
                animation.setAnimationListener(new AnimationListener() {
                        ...
                        public void onAnimationEnd(Animation animation) {
                            ...
                            popoverView.removeAllViews();
                            removeAllViews();
                            MyAppPopoverView.this.superview.removeView(MyAppPopoverView.this);
                            //End animation
                            isAnimating = false;
    ...
    public static interface PopoverViewDelegate {
         ...
         */
        void popoverViewWillShow(MyAppPopoverView view);

        /**
         * Called when the popover did show
         * @param view The whole popover view
         */
        void popoverViewDidShow(MyAppPopoverView view);

        /**
         * Called when the popover is going to be dismissed
         * @param view The whole popover view
         */
        void popoverViewWillDismiss(MyAppPopoverView view);

        /**
         * Called when the popover was dismissed
         * @param view The whole popover view
         */
        void popoverViewDidDismiss(MyAppPopoverView view);
    }
}
